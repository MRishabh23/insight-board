...
export const CloseIssueForm = ({ ...props }) => {
  ...
  const { mutate: server_close, isPending: closePending } = useCloseIssueMutation(form, setOpen);
      ...
      <Dialog open={open} onOpenChange={handleOpen}>
        ...
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Please enter the issue key <span className="font-bold text-black">{props.issueKey}</span> to close the
              issue.
            </DialogDescription>
          </DialogHeader>
