	...
	return (
		<Accordion type="single" collapsible className="w-full">
			<AccordionItem value="item-1">
				<AccordionTrigger className="font-bold text-lg text-primary">Things to Remember</AccordionTrigger>
				<AccordionContent>
					<ul className="list-inside list-decimal font-medium text-base text-neutral-500">{children}</ul>
				</AccordionContent>
			</AccordionItem>
		</Accordion>
	);
...
export function IssueAccordion() {
	return (
		<CommonAccordion>
			<li>
				Initially active and closed issues will be fetched automatically. And this result will be cached for
				sometime.
			</li>
			...
			<li>
				Send Notification, Close, and Delete buttons will show an additional modal to confirm whether you want
				to proceed with the clicked option.
			</li>
			<li>
				Upon updating, sending notification, closing, and deleting the issue, if the process is successful the
				latest data will be fetched automatically in the background and will be shown on the page.
			</li>
		</CommonAccordion>
	);
}
...
export function StatusAccordion() {
	return (
		<CommonAccordion>
			...
			<li>
				Upon creating, updating, closing, and deleting the status, if the process is successful the latest data
				will be fetched automatically in the background and will be shown on the page.
			</li>
		</CommonAccordion>
	);
}
...
export function InducedAccordion() {
	return (
		<CommonAccordion>
			...
			<li>
				We have data from 16th August 2024 onwards, as all the previous data is removed because there are some
...
export function AllReferenceAccordion() {
	return (
		<CommonAccordion>
			...
			<li>
				By default status will be ACTIVE. If status is CLOSED, reference type and queue options will be
				disabled.
			</li>
