...
const DuelSplit = React.forwardRef<
  HTMLDivElement,
...
const DuelSplitTitle = React.forwardRef<
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "text-4xl font-semibold uppercase leading-none tracking-wider text-white",
      className
    )}
    {...props}
  />
...
const DuelSplitSection = React.forwardRef<
  HTMLDivElement,
  React.HTMLAttributes<HTMLDivElement>
>(({ className, ...props }, ref) => (
  <div
