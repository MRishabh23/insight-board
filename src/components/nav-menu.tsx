...
export function NavigationMenuComponent() {
  ...
  const components: {
    ...
    {
      title: "OCEAN",
      path: `/dashboard/tracking/ocean/${params.env}/${params.dash}`,
      description: "Visit ocean dashboard to view metrics.",
    },
    {
      title: "AIR",
      path: `/dashboard/tracking/air/${params.env}/${params.dash}`,
      description: "Visit air dashboard to view metrics.",
    },
    {
      title: "TERMINAL",
      path: `/dashboard/tracking/terminal/${params.env}/${params.dash}`,
